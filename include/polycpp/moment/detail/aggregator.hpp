 ...
 * @brief Aggregates all moment detail headers.
 *
 * Include this single header to pull in every inline implementation.
 * The English locale is auto-registered via locale_en.hpp.
 */
#pragma once
